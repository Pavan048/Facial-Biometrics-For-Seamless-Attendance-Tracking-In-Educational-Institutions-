...
message = tk.Label(window, text="Facial Biometrics For Seamless Attendance Tracking In Educational Institutions" ,bg="Green"  ,fg="white"  ,width=50  ,height=3,font=('times', 30, 'italic bold underline')) 
...
# copyWrite.insert("insert", "Developed by Kumar sir","", "TEAM", "superscript")
